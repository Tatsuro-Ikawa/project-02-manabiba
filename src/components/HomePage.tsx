...
import HomeWhatsNewDojo from '@/components/home/HomeWhatsNewDojo';
              ...
              <div className="home-content-left">
                        ...
                        latestVideos
                          ...
                          .map((video, i) => (
                            <div key={`${video.url}-${i}`} className="video-item">
                              ...
                              >
                                {video.thumbnailUrl ? (
                                  <img src={video.thumbnailUrl} alt="" className="video-thumbnail-img" />
                                ) : (
                            ...
                            <div key={`${article.url}-${i}`} className="article-item-card">
                              ...
                              >
                                {article.thumbnailUrl ? (
                                  <img src={article.thumbnailUrl} alt="" className="article-thumbnail-img" />
                                ) : (
                              ...
                              <div className="article-card-body">
                                ...
                                {article.lead && <div className="article-card-lead">{article.lead}</div>}
                                {article.source && <div className="article-card-source">出所: {article.source}</div>}
                              </div>
                            </div>
                          ))
                      )}
                ...
                <section id="home-section-sns" className="content-section">
                  ...
                  <div className="sns-links">
                    <a href="#" className="sns-icon facebook" aria-label="Facebook">
                      f
                    </a>
                    <a href="#" className="sns-icon instagram" aria-label="Instagram">
                      📷
                    </a>
                    <a href="#" className="sns-icon twitter" aria-label="X">
                      X
                    </a>
                    <a href="#" className="sns-icon youtube" aria-label="YouTube">
                      ▶
                    </a>
                  </div>
                </section>
                        ...
                        .map((link, i) => (
                          ...
                          >
                            <span className="reference-link-thumb">
                              {link.thumbnailUrl ? (
                                <img src={link.thumbnailUrl} alt="" className="reference-link-thumb-img" />
                              ) : (
