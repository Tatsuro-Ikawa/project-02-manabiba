...
9. **Vertex AI（トライアル気づきノート：朝・晩コメント／週レポート・週改善提案）開発者向け** — [../VERTEX_AI_TRIAL_IMPROVEMENT.md](../VERTEX_AI_TRIAL_IMPROVEMENT.md)（`docs/` 直下。GCP 設定・環境変数・REST 仕様・週次 API・トラブルシュート）
