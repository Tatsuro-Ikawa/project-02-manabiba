      ...
      <div className="home-main-wrapper">
        <main className="legal-page-main">
          <div className="legal-page-content">
            ...
            <p className="legal-page-updated">最終更新日：2026年5月19日</p>
              ...
              <div>
                ...
                <dd>
                  <ul className="legal-list">
                    ...
                    <li>
                      <strong>支払時期</strong>：有料プラン（スタンダード／プレミアム）を初めてお申し込みいただいた場合、
              ...
              <div>
                ...
                <dd>
                  <ul className="legal-list">
                    ...
                    <li>
                      解約の効力は、解約手続きを当社が受け付けた時点で成立し、
                      <strong>現在の課金期間の末日</strong>をもって有料サービスの提供を終了します。
                      日割り計算による返金は、原則として行いません。
                    </li>
                    <li>
                      <strong>28日間の無料お試し期間中</strong>に解約された場合、料金は発生しません。
                    </li>
                    <li>
                      無料お試し期間終了後に課金が開始された後の、既にお支払いいただいた利用料金の返金は、
                      法令上返金義務が生じる場合を除き、原則としてお受けできません。
                    </li>
                    <li>
